###############Frag 0 ################
# Instructions: 
L4:sw $fp, 36($sp)add t34, $sp, 48move $fp, t34sw $ra, -16($fp)sw $s7, -48($fp)sw $s6, -44($fp)sw $s5, -40($fp)sw $s4, -36($fp)sw $s3, -32($fp)sw $s2, -28($fp)sw $s1, -24($fp)sw $s0, -20($fp)sw $a0, 0($fp)add t35, $fp, -8move t33, t35li $a0, 8jal _allocRecordmove t32, $v0la t36, L1sw t36, 0(t32)li t37, 1000sw t37, 4(t32)sw t32, (t33)la t38, L2lw t39, -8($fp)sw t38, 4(t39)lw t40, -8($fp)lw t41, -20($fp)move $s0, t41lw t42, -24($fp)move $s1, t42lw t43, -28($fp)move $s2, t43lw t44, -32($fp)move $s3, t44lw t45, -36($fp)move $s4, t45lw t46, -40($fp)move $s5, t46lw t47, -44($fp)move $s6, t47lw t48, -48($fp)move $s7, t48lw t49, -16($fp)move $ra, t49lw t50, 36($sp)move $fp, t50j L3L3:.text###############Frag 1 ################
L2:
.word 8
.asciiz "Somebody"
###############Frag 2 ################
