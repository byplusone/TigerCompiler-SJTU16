###############Frag 0 ################
# Instructions: 
L7:sw $fp, 36($sp)add t33, $sp, 44move $fp, t33sw $ra, -12($fp)sw $s7, -44($fp)sw $s6, -40($fp)sw $s5, -36($fp)sw $s4, -32($fp)sw $s3, -28($fp)sw $s2, -24($fp)sw $s1, -20($fp)sw $s0, -16($fp)sw $a0, 0($fp)li t32, 1li t34, 5li t35, 4bgt t34, t35, L0L1:li t32, 0L0:li t36, 0bne t32, t36, L4L5:la t37, L2L3:lw t38, -16($fp)move $s0, t38lw t39, -20($fp)move $s1, t39lw t40, -24($fp)move $s2, t40lw t41, -28($fp)move $s3, t41lw t42, -32($fp)move $s4, t42lw t43, -36($fp)move $s5, t43lw t44, -40($fp)move $s6, t44lw t45, -44($fp)move $s7, t45lw t46, -12($fp)move $ra, t46lw t47, 36($sp)move $fp, t47j L6L4:j L3L6:.text###############Frag 1 ################
L2:
.word 1
.asciiz " "
