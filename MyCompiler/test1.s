###############Frag 0 ################
# Instructions: 
L1:sw $fp, 36($sp)add t34, $sp, 48move $fp, t34sw $ra, -16($fp)sw $s7, -48($fp)sw $s6, -44($fp)sw $s5, -40($fp)sw $s4, -36($fp)sw $s3, -32($fp)sw $s2, -28($fp)sw $s1, -24($fp)sw $s0, -20($fp)sw $a0, 0($fp)add t35, $fp, -8move t33, t35li $a0, 10li $a1, 0jal initArraymove t32, $v0sw t32, (t33)lw t36, -8($fp)lw t37, -20($fp)move $s0, t37lw t38, -24($fp)move $s1, t38lw t39, -28($fp)move $s2, t39lw t40, -32($fp)move $s3, t40lw t41, -36($fp)move $s4, t41lw t42, -40($fp)move $s5, t42lw t43, -44($fp)move $s6, t43lw t44, -48($fp)move $s7, t44lw t45, -16($fp)move $ra, t45lw t46, 36($sp)move $fp, t46j L0L0:.text
